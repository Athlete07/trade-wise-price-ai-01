          ...
          <CardContent className="space-y-6">
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-semibold text-blue-600">{costs.markup}%</span>
              </div>
              <Slider
                value={[costs.markup]}
            ...
            <div className="space-y-3 pt-4 border-t">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between font-bold text-lg border-t pt-2">
                  ...
                  <span className="text-green-600">${calculateFinalPrice().toLocaleString()}</span>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="border-orange-200 bg-orange-50">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div>
                <h4 className="font-semibold text-orange-900 mb-2">Seller Pays:</h4>
                <ul className="space-y-1">
                  {selectedIncoterm.sellerResponsibility.map((item, index) => (
                    <li key={index} className="flex items-center space-x-2 text-orange-800">
              ...
              <div>
                <h4 className="font-semibold text-orange-900 mb-2">Buyer Pays:</h4>
                <ul className="space-y-1">
